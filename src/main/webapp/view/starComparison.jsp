...
<script language="JavaScript">
    ...
    $(function () {
        ...
        $('.M-box').pagination({
            ...
            callback:function (api) {
                page = api.getCurrent();
                window.location.href = "/MRAS//comparison/star?keyword=" + keyword + "&nationality=" + nationality + "&type=" + type+"&page="+page;
            }
        });
        //初始化已经选择好的预测方案
        ...
        $(".nationality label").click(function () {
            ...
            window.location.href = "/MRAS//comparison/star?keyword=" + keyword + "&nationality=" + nationality + "&type=" + type;
    ...
    function addmakers(obj) {
        ...
        if (type == "star") {
            ...
            if(forecast_stars.length==2){
                alert("You can compare only 2 stars at 1 time!");
                return;
            }
            var label_var = document.createElement("label");
            var inner = name+" ×";
